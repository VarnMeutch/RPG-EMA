...
public abstract class Projectile extends Entity
{
    ...
    protected float m_lifeSpan, m_lifeTime;
    protected float m_speed;
    protected HitBox m_hitbox;

    public Projectile(ArrayList<Entity> entitiesList, AssetManager assetManager, float direction, float speed, float lifeSpan)
    {
